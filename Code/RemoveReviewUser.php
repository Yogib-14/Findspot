<div class="modal fade" id="removereview<?php echo $row['id_review']; ?>">
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="RemoveReviewUserProses.php?id_review=<?php echo $row['id_review']; ?>" class="btn btn-danger"><span class="fa fa-trash"></span> Yes</a>
                </form>
            </div>
        </div>
    </div>
