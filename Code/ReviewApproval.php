<html lang = "en">
    <head>
        ...
        <link rel = "stylesheet" href = "css/styleReviewApproval.css">
	...
	<div style="margin-top:10px;">
		<table class="table table-striped table-bordered">
			<thead>
				...
				<th class="text-center align-middle">Email User</th>
				...
				<?php
					...
					while($row=$query->fetch_array()){
						...
						<tr class="text-center">
							...
							<td style="width: 500px;" class="text-center align-middle"><?php echo $row['email_user']; ?></td>
                            ...
                            if($row['status']=="Pending"){
                                ?>
                                <a href="#approvereview<?php echo $row['id_review']; ?>" data-toggle="modal" class="btn btn-success btn-sm"><span class="fa fa-pencil"></span> Approve</a> ||
                                <?php include('ApproveReview.php');?>
	...
	$(document).ready(function(){
		$("#statuslist").on('change', function(){
			if($(this).val() == 0)
			{
				window.location = 'ReviewApproval.php?review_status='+$(this).val();
			}
			else
			{
				window.location = 'ReviewApproval.php?review_status='+$(this).val();
